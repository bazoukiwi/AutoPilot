...
float M_cal[6] = {172.0, 256.0, -270.0, 0.96, 0.92, 1.04}; // can make both 3x3 to handle off-diagonal corrections
float G_off[3] = { -310.4, 135.7, 278.0}; //raw offsets, determined for gyro at rest
// ^^^^^^^^^^^^^^^^^^^ VERY VERY IMPORTANT ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
